...
public interface PartageInterface extends Remote{
	...
	public boolean getIsMsgSend() throws RemoteException;
	public void setIsMsgSend(boolean b) throws RemoteException;
	
	public boolean getIsBoardSend() throws RemoteException;
	public void setIsBoardSend(boolean b) throws RemoteException;
	
	public void msgShare(String msg) throws RemoteException;
	public String getMsgShared() throws RemoteException;
